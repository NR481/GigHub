...
const MainPage = () => {
    ...
    const profilesObj = useAppSelector((state) => state.profiles);
    ...
    const submitNewProfile = async (e: Event) => {
        e.preventDefault();
        ...
        if (!user)
            validationErrors.push(
                "Please Log in or Sign up to create a profile",
            );
        if (!imgRegex.test(image.name))
            validationErrors.push("Please enter a valid Image File");
                            ...
                            <FileUploader
                                ...
                                children={
                                    <div className="file-drop">
                                        <p>
                                            Drag and drop file to upload profile
                                            image
                                        </p>
                                        <p>or</p>
                                        <p>
                                            <u>Browse local files</u>
                                        </p>
                                        {image && (
